...
urlpatterns = [
    ...
    path('definitions/attribute_classes', views.definitions_attribute_classes, name='definitions_attribute_classes'),
    ...
    path(r'definitions/updateResourceDetail', views.updateResourceDetail, name='updateResourceDetail'),
    ...
    path(r'definitions/updateResourcePropertyDetail', views.updateResourcePropertyDetail, name='updateResourcePropertyDetail'),
    path(r'definitions/addResourceProperty', views.addResourceProperty, name='addResourceProperty'),
    path(r'definitions/removeResourceProperty', views.removeResourceProperty, name='removeResourceProperty'),
    ...
    path(r'definitions/updateAttributeClassDetail', views.updateAttributeClassDetail, name='updateAttributeClassDetail'),
    path(r'definitions/addAttributeClass', views.addAttributeClass, name='addAttributeClass'),
    path(r'definitions/removeAttributeClassDetail', views.removeAttributeClassDetail, name='removeAttributeClassDetail'),
    ...
    path(r'definitions/removeTargetSystemDetail', views.removeTargetSystemDetail, name='removeTargetSystemDetail'),
